...
contextBridge.exposeInMainWorld('api', {
  ...
  checkAccessibilityPermission: (prompt) => ipcRenderer.invoke('check-accessibility-permission', prompt),
  testAutomationPermission: () => ipcRenderer.invoke('test-automation-permission'),
  openPrivacyPane: (pane) => ipcRenderer.send('open-privacy-pane', pane),
